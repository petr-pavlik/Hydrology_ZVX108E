...
on how to study, describe, extract, evaluate and report about the data. Hence the workflow 
is specific to data in process.\
...
With **measures of variability** we describe the spread of the data around its . 
Some degree of variability is a natural occurring phenomenon. 
