...
Within this introduction we use WhiteboxTools, a modern and advanced geospatial
package, which contains ~450 tools and functions. The advantage of using WBT
is in capability of inducing command line functions from within R.
...
river channels. Hydrologist utilize indices such as **stream length**, **Strahler 
order**
